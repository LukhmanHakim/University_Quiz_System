...
$getid = $_GET['modifyid'];
$sql = "SELECT * FROM quizmultiplechoice WHERE id = '$getid'";
...
if(isset($_POST['updateedit'])) {
    ...
    $sqledit = "UPDATE quizmultiplechoice SET lect_name= '$uplect', Course_Name = '$upname', question = '$upquestion', realanswer = '$upanswer' WHERE id = '$upid'";
