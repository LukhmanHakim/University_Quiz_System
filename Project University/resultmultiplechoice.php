...
<html>
   ...
   <body>
       <h2 style="font-size : 30px;">Here your result for True/False quiz section</h2>
       <h2 style="font-size : 30px;">Score Answer</h2>
       <br>
...
$sql = "SELECT * FROM student_multiplechoice_marks WHERE student_ID = '$newid'";
